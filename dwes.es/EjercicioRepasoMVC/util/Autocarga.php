...
class Autocarga{
    ...
    public static function autocarga($clase){
        ...
        $directorio_de_busqueda = "/EjercicioRepasoMVC";
        ...
        if (file_exists($_SERVER['DOCUMENT_ROOT'] . $directorio_de_busqueda . "/" . "$clase" . ".php")){
            // Y si existe, hacemos el require_once de esa clase
            require_once($_SERVER['DOCUMENT_ROOT'] . $directorio_de_busqueda . "/" . "$clase" . ".php");
        } else {
            // Que no existe, pues devolvemos una excepción
            throw new Exception("No existe el directorio: " . $_SERVER['DOCUMENT_ROOT'] . $directorio_de_busqueda . "/" . "$clase" . ".php");
        }
    }
