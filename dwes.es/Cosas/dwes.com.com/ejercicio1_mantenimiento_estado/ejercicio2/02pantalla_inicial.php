<?php
    ...
    session_start();
    ob_start();
    require_once($_SERVER['DOCUMENT_ROOT'] . "/dwes.com.com/ejercicio1_mantenimiento_estado/includes/functions.php");
    ...
    // en este apartado.
        ...
        header("Location: /dwes.com.com/ejercicio1_mantenimiento_estado/ejercicio2/02pantalla_imagenes.php");
    } else {
